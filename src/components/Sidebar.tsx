...
import { LayoutDashboard, Calendar, Settings, Users, LogOut, Users as UsersIcon, Car, Calculator, Wrench, Package, Shield, ShoppingCart } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ currentView, onViewChange, onLogout }) => {
  const menuItems = [
    ...
    { id: 'procurement' as ViewType, icon: ShoppingCart, label: 'Procurement', badge: '6' },
